...
from DNN_Optimiser import Optimiser, SGD, Adam
...
class NeuralNetwork:
    ...
    def backProp(self, optimiser, z, a, y, t):
    ...
    def fit(self, optimiser, L2, epochs, X, Y, batchSize, loss, weightsAndBiasesFile='', diagnosticsFile=''):
        ...
        for epoch in range(epochs):
            ...
            for n in range(0, len(Y) - batchSize + 1, batchSize):
                ...
                self.backProp(optimiser, z, a, Y[indices], epoch)                
        
            # check error
            if epoch % 10 == 0:
                loss1, loss2 = self.calcSplitLoss(X,Y)
                print('epoch = ', epoch, 'loss1 = ',loss1, 'loss2 = ', loss2, 'eta = ', optimiser.eta)
